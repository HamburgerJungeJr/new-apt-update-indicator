...
var AptUpdateIndicator = new Lang.Class({
    ...
    _init: function(updateManager) {
        ...
        this._generic_icon = Gio.icon_new_for_string(Me.path + '/media/apt-update-indicator-symbolic.svg');
        this._sync_icon = Gio.icon_new_for_string('emblem-synchronizing-symbolic');
        this._avail_icon = Gio.icon_new_for_string('software-update-available-symbolic');
        this._urgent_icon = Gio.icon_new_for_string('software-update-urgent-symbolic');
        this._warning_icon = Gio.icon_new_for_string('dialog-warning-symbolic');

        this.updateIcon = new St.Icon({
            gicon: this._generic_icon,
    ...
    showChecking: function(isChecking) {
        if (isChecking == true) {
            this.updateIcon.set_gicon(this._sync_icon);
    ...
    updateStatus: function(updatesCount) {
        ...
        if (updatesCount > 0) {
            ...
            if (this._urgentList.length > 0) {
                this.updateIcon.set_gicon(this._urgent_icon);
            } else{
                this.updateIcon.set_gicon(this._avail_icon);
            }
            ...
            if (updatesCount == STATUS.UNKNOWN) {
                ...
                this.updateIcon.set_gicon(this._warning_icon);
                ...
                this.updateIcon.set_gicon(this._generic_icon);
    ...
    _showNotification: function(title, message) {
        if (this._notifSource == null) {
            ...
            this._notifSource.createIcon = function() {
                return new St.Icon({ gicon: this._generic_icon, });
            };
